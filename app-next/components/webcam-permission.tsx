...
export interface WebcamPermissionProps {
...
export function WebcamPermission({
    ...
    const handleRequestAccess = async () => {
        ...
        if (success && onPermissionGranted) {
            // Don't call immediately - let user see the preview first
        }
    };

    const handleContinue = () => {
        if (isStreaming && onPermissionGranted) {
            onPermissionGranted();
        }
    };
                        ...
                        <div className="space-y-2 text-center">
                            ...
                            {permissionState === 'prompt' && (
                                <p className="text-sm text-zinc-500">
                                    You&apos;ll see a browser prompt asking for
                                    permission.
                                </p>
                            )}
                        </div>
...
// ============================================================================
// Export videoRef getter for parent components
// ============================================================================
